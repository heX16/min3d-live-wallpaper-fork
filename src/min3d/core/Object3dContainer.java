...
public class Object3dContainer extends Object3d implements IObject3dContainer {
	 ...
	 * 
	 * Subclass Object3dContainer instead of Object3d if you believe you may want to add children to that object.
	 */
	...
	public Object3d getChildByName(String $name) {
		...
		{
			if (_children.get(i).name().equals($name))
	...
	public Object3dContainer clone() {
		...
		Object3dContainer clone = new Object3dContainer(v, f, new TextureList());
